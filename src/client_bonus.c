...
/*   Updated: 2024/01/12 19:28:13 by aaamam           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/minitalk_bonus.h"
/*	we use confirm_msg function to verify if the server has 
	recieved the signal (server send kill(info->si_pid, SIGUSR2);)	*/
